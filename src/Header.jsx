...
import Logoimg from "../src/assets/blacklogo.png";
import "./App.css";
...
const Header = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <header className="flex md:flex-row md:justify-between py-5 bg-header ">
      <div className="ml-8 md:ml-20">
        <img src={Logoimg} className="h-[70px] md:h-[90px] " alt="Logo" />
      </div>
      <nav className="hidden md:block">
        <ul className="flex text-skills text-lg font-bold gap-10 mt-7 justify-center">
          <li>
      ...
      {toggleMenu && (
        <nav className="block md:hidden ">
          <ul
            ...
            className="flex flex-col text-white mt-10 mobile-nav z-10"
          >
            <li>
              <a href="#" className="hover-underline">
                Home
      ...
      <div className="flex flex-row  ">
        <button className="border-4 border-white-500 dark:border-gray-500 bg-black dark:bg-skills px-4 py-2 h-10 ml-10 md:mr-20 md:h-12 rounded md:mt-5 mt-4  text-bold text-white">
          {darkMode ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="md:h-7 md:w-7 h-5 w-5 fill-yellow-400"
              viewBox="0 0 24 24"
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="md:h-7 md:w-7 h-5 w-5 fill-white text-white"
              viewBox="0 0 24 24"
              onClick={() => toggleDarkMode()}
            >
        ...
        <button
          onClick={() => setToggleMenu(!toggleMenu)}
          className="block  md:hidden ml-24"
        >
